...
if(isset($_POST['submit']))
  {	
	...
	echo "<script type='text/javascript'> document.location = 'gallery-manage.php'; </script>";
  }
?>
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body">
										...
										<center>
												...
												<div2><img src="../images/gallery/<?php echo htmlentities($result->thumbnail);?>" width="540px"/></div2>
										</center>
										<br>
