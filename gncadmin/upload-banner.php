...
header('location:index.php');
  ...
  {	
	...
	$sql="insert into banners (image, title, link) values (:image,:title,:link)";
						...
						<div class="row">
                            ...
                            <h2>UPLOAD BANNERS</h2>
								<div class="panel panel-default">
									<div class="panel-heading">UPLOAD BANNERS</div>
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="file" name="image" class="form-control" id="img" required onchange="readURL(this);" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="text" name="link" placeholder="Do not use more than 100 words" class="form-control" required>
											</div>
										</div>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="upload-banner.php"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
