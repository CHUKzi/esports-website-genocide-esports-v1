...
if(isset($_POST['submit']))
  {	
	...
	$sql="UPDATE tournament_teams SET logo=(:logo), team=(:team) WHERE id=(:idedit)";
...
<?php
		$sql = "SELECT * from tournament_teams where id = :editid";
		$query = $dbh -> prepare($sql);
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body" style="background-color:#40E0D0;">
										...
										<center>
												...
												<div2><img src="../images/tournament/<?php echo htmlentities($result->logo);?>" width="80px"/></div2>
										</center>
										<br>
										<div class="form-group">
											...
											<input type="file" name="logo" class="form-control" id="img" onchange="readURL(this);" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="text" name="team" placeholder="Do not use more than 100 words" value="<?php echo htmlentities($result->team);?>" class="form-control" required>
											</div>
										</div>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												<a href="match-teams-page.php?tournament=<?php echo htmlentities($result->tournament);?>"><button class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back Here</button></a>

												<a href="match-teams-page.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure want to Delete this post?');"><button class="btn btn-danger"><i class="fa fa-trash"></i> DELETE BOLOG </button></a>

												<a href="edit-match-team.php?edit=<?php echo $result->id;?>"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
