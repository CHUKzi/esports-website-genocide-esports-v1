						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Manage Gallery</div>
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<center>
									<div class="boxe">
										<div class="boxcenter">
											<a href="upload-project.php"><button class="btn btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Upload NEW Image</button></a>
										</div>
									</div>
									</center>
								</div>
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    {               ?>
										<tr>
											...
											<td><img src="../images/gallery/<?php echo htmlentities($result->thumbnail);?>" class="" alt="" width="150"></td>
                                            <td><?php echo htmlentities($result->time);?></td>
                                            											
<td>
<a href="edit-gallery.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
<a href="gallery-manage.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure want to Delete This Post?');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
