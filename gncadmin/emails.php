...
$sql="UPDATE notification SET emails='$emails' WHERE id='1'";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Contact E-mailes</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">List e-mails</div>
...
<?php
 ...
 ?>
                                            ...
                                            <td>
											<a href="show-contact-mails.php?email=<?php echo $result->id;?>">&nbsp; <i class="fa fa-eye"></i>&nbsp;view more</a>
											</td>
											<td>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="emails.php"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
