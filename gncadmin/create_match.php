...
if(isset($_GET['tournament']))
  ...
  {	
	...
	$score_team_1='0';
  	$score_team_2='0';
  	$is_mach_end='0';
  	$live_link='matches/live';

	$sql="insert into tournament_matches (tournament, title, subtitle, game_name, team_1, team_2, mach_time, score_team_1, score_team_2, is_mach_end, live_link) values (:tournament,:title,:subtitle,:game_name,:team_1,:team_2,:mach_time,:score_team_1,:score_team_2,:is_mach_end,:live_link)";
	...
	$query-> bindParam(':is_mach_end', $is_mach_end, PDO::PARAM_STR);
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="text" name="game_name" placeholder="Do not use more than 100 words" class="form-control" required>
											</div>
										</div>
                            ...
                            <option value="">Select Team</option>
                                    <?php $sql = "SELECT * from tournament_teams WHERE tournament='{$tou_id}' order by time DESC";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>
                            <option value="<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->team);?></option>
							<?php $cnt=$cnt+1; }} ?>
							</select>
                            </div>
							...
							<?php $cnt=$cnt+1; }} ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="datetime-local" name="mach_time" placeholder="Do not use more than 100 words" class="form-control" required>
											</div>
										</div>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="create_match.php?tournament=<?php echo($tou_id);?>"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
