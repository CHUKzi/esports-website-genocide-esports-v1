...
if(isset($_POST['submit']))
  {	
	...
	$sql="UPDATE our_sponsors SET thumbnail=(:thumbnail), link=(:link) WHERE id=(:idedit)";
	...
	echo "<script type='text/javascript'> document.location = 'sponsors-manage.php'; </script>";
  }
?>
...
<?php
		$sql = "SELECT * from our_sponsors where id = :editid";
		$query = $dbh -> prepare($sql);
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body" style="background-color:#40E0D0;">
										...
										<center>
												...
												<div2><img src="../images/clients/<?php echo htmlentities($result->thumbnail);?>" width="240px"/></div2>
										</center>
										<br>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Redirect Link<span style="color:red">*</span></label>
											<div class="col-sm-9">
											<input type="text" name="link" placeholder="Do not use more than 100 words" class="form-control" required value="<?php echo htmlentities($result->link);?>">
											</div>
										</div>
										<div class="form-group">
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="edit-gallery.php?edit=<?php echo htmlentities($result->id);?>"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
