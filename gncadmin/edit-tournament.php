...
if(isset($_POST['submit']))
  {	
	...
	$sql="UPDATE our_tournament SET title=(:title), subtitle=(:subtitle), bracket_template=(:bracket_template) WHERE id=(:idedit)";
...
<?php
		$sql = "SELECT * from our_tournament where id = :editid";
		$query = $dbh -> prepare($sql);
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
											<input type="text" name="bracket_template" placeholder="Do not use more than 100 words" class="form-control" required value="<?php echo htmlentities($result->bracket_template);?>">
											</div>
										</div>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												<a href="matches-manage.php"><button class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back Here</button></a>

												<a href="edit-tournament.php?edit=<?php echo($editid);?>"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
