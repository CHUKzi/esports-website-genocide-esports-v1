...
$sql = "UPDATE tournament_matches SET is_mach_end='0' WHERE id='{$end_match}'";
$query = $dbh->prepare($sql);
$query -> execute();
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading"><a href="recent-match.php?tournament=<?php echo($tou_id);?>"><button type="button" class="btn btn-success btn-sm">Refresh</button></a> Manage-Tournament / Manage-Matches</div>
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<center>
												<a href="tournament-page.php?tournament=<?php echo($tou_id);?>"><button class="btn btn-success"><i class="fa fa-arrow-left"></i> Go Back Here</button></a>

												<a href="recent-match.php?tournament=<?php echo($tou_id);?>"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>

												<a href="tournament-page.php?tournament=<?php echo($tou_id);?>" target="_blank"><button class="btn btn-secondary"><i class="fa fa-eye"></i> Preview </button></a>
									</center>
								</div>
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <?php $sql = "SELECT * from tournament_matches WHERE tournament='{$tou_id}' AND is_mach_end = '1' order by time DESC";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>
										<tr>
                                            ...
                                            <td><a href="recent-match.php?tournament=<?php echo($tou_id);?>&&end=<?php echo $result->id;?>" onclick="return confirm('Are you sure want end Match?');"><button type="button" class="btn btn-success btn-sm">Re Up coming match</button></a></td>
                                            											
											<td><a href="edit-score.php?edit=<?php echo $result->id;?>"><button type="button" class="btn btn-info btn-sm">Edit Score</button> </a></td>
											<td>
