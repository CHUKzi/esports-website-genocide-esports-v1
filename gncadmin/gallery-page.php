...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE gallery_page_head SET back_img=(:back_img), title=(:title) WHERE id=(:idedit)";
...
<head>
	...
	<title>MANAGE WEB PAGES - OUR WORKS PAGE</title>
...
<?php
		$sql = "SELECT * from gallery_page_head where id = 1";
		$query = $dbh -> prepare($sql);
		$query->execute();
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">OUR WORKS PAGE</div>
									...
									<div id="progress-bar-file1" class="progress"></div>
										...
										<center>
											<div class="col-sm-12 col-sm-offset-0">
												...
												<a href="our-works-page.php"><button class="btn btn-info"><i class="fa fa-refresh"></i> Refresh</button></a>
