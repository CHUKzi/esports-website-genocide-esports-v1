...
if(isset($_POST['submit2']))
  {
	...
	$sender='Admin';
	$history_type=',s E-mail Recovery ';
    ...
    $query->execute();
    header('Location: emails.php?result=Recovery-Successfully..');
}    
?>
<!doctype html>
...
<head>
	...
	<title>RECOVERY E-MAIL MESSAGE</title>
...
<div class="form-group">
	...
	<div class="col-sm-8">
	<textarea class="form-control" cols="30" rows="10" disabled=""><?php echo $result->message;?></textarea>
	</div>
</div>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		...
		<button class="btn btn-success" name="submit2" type="submit"onclick="return confirm('Are you sure you want to Recovery This E-mail?');"> <i class="fa fa-undo"></i>&nbsp;Recovery This E-mail</button>
	</div>
</div>
</form>
<a href="emails-recovery.php"><button class="btn btn-brand"><i class="fa fa-mail-reply"></i>&nbsp;Back To Delete list</button></a>
