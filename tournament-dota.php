		...
		<table class="display" style="width:100%">
			...
			<tr>
                ...
                <th>Match Date & time</th>
							...
							<tbody>
                                    <?php $sql = "SELECT * from tournament_matches WHERE tournament='121' AND is_mach_end = '0' AND game_name = 'DOTA 2' order by time";
...
<h4><b>RECENT MATCHES</b></h4>
								...
								<table class="display" style="width:100%">
                                    ...
                                    <?php $sql = "SELECT * from tournament_matches WHERE tournament='121' AND is_mach_end = '1' AND game_name = 'DOTA 2' order by time DESC";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                                    $cnt=1;
